...
+ (NSArray * _Nonnull)resizedImagesToSize:(NSArray * _Nonnull)images toSize:(CGSize)dstSize {
    NSMutableArray *arrayResizedImage = [NSMutableArray array];
    ...
    for (UIImage *currentImage in images) {
        ...
        if (CGSizeEqualToSize(srcSize, dstSize)) {
            return arrayResizedImage;
        }
        
        CGFloat scaleRatio = dstSize.width / srcSize.width;
        UIImageOrientation orient = currentImage.imageOrientation;
        ...
        UIGraphicsBeginImageContextWithOptions(dstSize, NO, currentImage.scale);
        ...
        [arrayResizedImage addObject:resizedImage];
    }
